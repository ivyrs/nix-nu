-- Generated noctalia theme for neovim
-- Rendered by noctalia's user-template engine; {{...}} tokens become real
-- hex values. Loaded at runtime via dofile() from home/noctalia/default.nix's
-- luaConfigRC.noctalia-theme, which also owns the SIGUSR1 reload handler.
local M = {}
